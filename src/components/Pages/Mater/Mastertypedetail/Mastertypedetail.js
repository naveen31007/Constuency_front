...
export default function Mastertypedetail() {
  ...
  useEffect(() => {
    fetch("http://localhost:5211/api/MasterType/api/panel/getlist/mastertype")
  ...
  const handleDelete = async (id, resetForm) => {
      ...
      <div className="container-admin">
        <div className="card add-card ">
          <div className="card-body">
            <h5 className="card-title">Insert Master Type Details</h5>
            <Formik
              enableReinitialize
              initialValues={{
                name: getbyid != null ? getbyid.name : "",
                // parentId:  0,
                typeId: getbyid != null ? getbyid.typeId : "",
              }}
